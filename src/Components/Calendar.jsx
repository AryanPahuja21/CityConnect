...
const Calendar = () => {
  return (
    <div>
        <div className='text-7xl w-fit mx-auto'>Event Calendar</div>
      ...
      <table class="w-full">
        ...
        <tbody>
          <tr class="text-center h-20">
            <td class="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 bg-red-500">
              <div class="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 overflow-hidden ">
                <div class="top h-5 w-full">
                  <span class="text-white">1</span>
                </div>
                <div>
                    <p className='h-fit mt-10 font-bold'>KRSNA Concert</p>
                </div>
          ...
          <tr class="text-center h-20">
            ...
            <td class="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 bg-green-400">
            <div class="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 overflow-hidden ">
                <div class="top h-5 w-full">
                  <span class="text-white">14</span>
                </div>
                <div>
                    <p className='h-fit mt-10 font-bold'>Cultural Event, JLN</p>
                </div>
          ...
          <tr class="text-center h-20">
            ...
            <td class="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 bg-blue-600">
            <div class="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 overflow-hidden ">
                <div class="top h-5 w-full">
                  <span class="text-white">25</span>
                </div>
                <div>
                    <p className='h-fit mt-10 font-bold'>Trade Fair</p>
                </div>
