...
const Report = () => {
    ...
    const CardP = ({title,desc})=>{
      ...
      <p className="font-normal text-gray-700 m-3">
        {desc}
      </p>
      <Button className='m-3 hover:bg-cyan-700'>
  ...
  return (
    <div>
    <h1 className='w-fit mx-auto text-5xl font-bold mt-4'>Reportable Crimes: Speak Up, Take Action</h1>
